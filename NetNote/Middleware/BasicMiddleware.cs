...
namespace NetNote.Middleware
{
    public class BasicMiddleware
    {
        ...
        public const string WWWAuthenticaterHeader = "WWW-Authenticate";
        ...
        /// <returns></returns>
        public static Task BasicResult(HttpContext httpContext)
        {
            httpContext.Response.StatusCode = 401;
            httpContext.Response.Headers.Add(WWWAuthenticaterHeader, "Basicrealm=\"localhost\"");
            return Task.FromResult(httpContext);
        }
    }
    public static class BasicMiddlewareExtension
    {
